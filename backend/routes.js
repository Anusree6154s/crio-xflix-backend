...
router.get("/", async (req, res) => {
  try {
    ...
    if (contentRating) {
      // const allowedRatings = ["Anyone", "7+", "12+", "16+", "18+"];
      // const ratingIndex = allowedRatings.indexOf(
      //   decodeURIComponent(contentRating)
      // );
      filter.contentRating =  decodeURIComponent(contentRating);
      // filter.contentRating = { $in: allowedRatings.slice(0, ratingIndex + 1) };
    }
